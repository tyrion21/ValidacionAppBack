...
exports.ExistenciasService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma/prisma.service");
let ExistenciasService = class ExistenciasService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async getExistencia(folio) {
        try {
            const existencia = await this.prisma.prismaClient3.existencias_cajas.findUnique({
                where: {
                    Folio: folio,
                },
            });
    ...
    async getMixExistencia(folio) {
        try {
            const existencia = await this.prisma.prismaClient3.existenciamix_cajas.findUnique({
                where: {
                    Folio: folio,
                },
            });
...
exports.ExistenciasService = ExistenciasService;
exports.ExistenciasService = ExistenciasService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], ExistenciasService);
//# sourceMappingURL=existencias.service.js.map