...
let ValidacionService = class ValidacionService {
    ...
    async verificarExistenciaFolio(folio) {
        try {
            ...
            console.error(...oo_tx(`584970554_32_6_32_68_11`, 'Error verificando existencia de folio:', error));
            return false;
        }
    }
    ...
    async getCajasPacking() {
        try {
            console.log(...oo_oo(`584970554_106_6_106_49_4`, 'Consultando cajas-packing...'));
            ...
            console.log(...oo_oo(`584970554_120_6_120_65_4`, `Se encontraron ${resultado.length} registros`));
            return resultado;
        }
        catch (error) {
            console.error(...oo_tx(`584970554_123_6_123_65_11`, 'Error detallado en getCajasPacking:', error));
    ...
    async getCajasValidadas() {
        try {
            ...
            console.error(...oo_tx(`584970554_140_6_140_57_11`, 'Error en getCajasValidadas:', error));
    ...
    async getCajasPackingSummary(fecha, linea) {
        try {
            console.log(...oo_oo(`584970554_148_6_150_7_4`, `Consultando resumen con filtros - fecha: ${fecha}, linea: ${linea}`));
            const where = {};
            if (fecha) {
            ...
            console.error(...oo_tx(`584970554_185_6_185_72_11`, 'Error detallado en getCajasPackingSummary:', error));
    ...
    async getCajasValidadasSummary(fecha, linea) {
        try {
            console.log(...oo_oo(`584970554_194_6_196_7_4`, `Consultando resumen con filtros - fecha: ${fecha}, linea: ${linea}`));
            const where = {};
            if (fecha) {
                where.Fecha_packing = fecha;
            }
            ...
            console.error(...oo_tx(`584970554_231_6_231_72_11`, 'Error detallado en getCajasPackingSummary:', error));
            throw new common_1.InternalServerErrorException(`Error al obtener resumen de cajas packing: ${error.message}`);
        }
    }
    async getCajasDesviacionesSummary(fecha, linea) {
        try {
            console.log(...oo_oo(`584970554_246_6_248_7_4`, `Consultando resumen de desviaciones con filtros - fecha: ${fecha}, linea: ${linea}`));
            const where = {};
            if (fecha) {
                where.Fecha_packing = fecha;
            }
            ...
            console.error(...oo_tx(`584970554_280_6_280_77_11`, 'Error detallado en getCajasDesviacionesSummary:', error));
    ...
    async createRechazo(rechazoDto) {
        try {
            ...
            console.log(...oo_oo(`584970554_297_6_297_58_4`, 'Valores recibidos para createRechazo:'));
            console.log(...oo_oo(`584970554_298_6_298_57_4`, 'Folio:', Folio, 'tipo:', typeof Folio));
            console.log(...oo_oo(`584970554_299_6_299_63_4`, 'Especie:', Especie, 'tipo:', typeof Especie));
            console.log(...oo_oo(`584970554_300_6_300_57_4`, 'Cajas:', Cajas, 'tipo:', typeof Cajas));
            console.log(...oo_oo(`584970554_301_6_301_60_4`, 'Camara:', Camara, 'tipo:', typeof Camara));
            console.log(...oo_oo(`584970554_302_6_302_63_4`, 'Packing:', Packing, 'tipo:', typeof Packing));
            console.log(...oo_oo(`584970554_303_6_303_75_4`, 'Motivos:', Motivos, 'es array:', Array.isArray(Motivos)));
            const existe = await this.verificarExistenciaFolio(Folio);
            if (!existe) {
                throw new common_1.NotFoundException(`El folio ${Folio} no existe en el sistema de existencias`);
            }
            ...
            for (const motivo of Motivos) {
                if (!motivo || !motivo.id) {
                    console.warn(...oo_tr(`584970554_350_10_350_60_8`, 'Motivo sin ID, se omitirá:', motivo));
                    continue;
                }
                ...
                try {
                    ...
                    console.error(...oo_tx(`584970554_384_10_384_89_11`, 'Error al crear registro de rechazo para motivo:', motivo, error));
                }
            }
            ...
            console.error(...oo_tx(`584970554_399_6_399_53_11`, 'Error en createRechazo:', error));
            if (error instanceof common_1.ConflictException) {
                throw error;
            }
    ...
    async getMotivosRechazo() {
        try {
            ...
            console.error(...oo_tx(`584970554_427_6_427_66_11`, 'Error al obtener motivos de rechazo:', error));
    ...
    async verificarRechazoPorFolio(folio) {
        try {
            ...
            console.error(...oo_tx(`584970554_463_6_463_64_11`, 'Error en verificarRechazoPorFolio:', error));
    ...
    async actualizarEstadoRechazo(folio) {
        try {
            ...
            console.error(...oo_tx(`584970554_501_6_501_63_11`, 'Error en actualizarEstadoRechazo:', error));
    ...
    async verificarValidacionPorFolio(folio) {
        try {
            ...
            console.error(...oo_tx(`584970554_525_6_525_67_11`, 'Error en verificarValidacionPorFolio:', error));
    ...
    async getInformeDiario(fecha, estado) {
        try {
            ...
            console.error(...oo_tx(`584970554_565_6_565_62_11`, 'Error al obtener informe diario:', error));
