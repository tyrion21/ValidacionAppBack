...
let ValidacionController = class ValidacionController {
    ...
    async create(createValidacionDto) {
        try {
            console.log(...oo_oo(`2402220953_24_6_24_95_4`, 'Received validation request:', JSON.stringify(createValidacionDto, null, 2)));
            const resultado = await this.validacionService.create(createValidacionDto);
            return resultado;
        }
        catch (error) {
            console.error(...oo_tx(`2402220953_28_6_28_58_11`, 'Error processing validation:', error));
    ...
    async rechazarPallet(rechazoDto) {
        try {
            console.log(...oo_oo(`2402220953_203_6_203_85_4`, 'Received rejection request:', JSON.stringify(rechazoDto, null, 2)));
            console.log(...oo_oo(`2402220953_204_6_204_45_4`, 'Tipo de datos recibidos:'));
            console.log(...oo_oo(`2402220953_205_6_205_54_4`, '- Folio:', typeof rechazoDto.Folio));
            console.log(...oo_oo(`2402220953_206_6_206_58_4`, '- Especie:', typeof rechazoDto.Especie));
            console.log(...oo_oo(`2402220953_207_6_207_54_4`, '- Cajas:', typeof rechazoDto.Cajas));
            console.log(...oo_oo(`2402220953_208_6_208_104_4`, '- Motivos:', Array.isArray(rechazoDto.Motivos) ? 'array' : typeof rechazoDto.Motivos));
            if (!rechazoDto.Folio) {
            ...
            console.error(...oo_tx(`2402220953_226_6_226_57_11`, 'Error processing rejection:', error));
