...
let ValidacionService = class ValidacionService {
    ...
    async verificarExistenciaFolio(folio) {
        try {
            ...
            console.error(...oo_tx(`3921148959_32_6_32_68_11`, 'Error verificando existencia de folio:', error));
            return false;
        }
    }
    async create(createValidacionDto) {
        ...
        try {
            ...
            if (!existe) {
                throw new common_1.NotFoundException(`El folio ${Folio} no existe en el sistema de existencias`);
            }
    ...
    async getCajasPacking() {
        try {
            console.log(...oo_oo(`3921148959_106_6_106_49_4`, 'Consultando cajas-packing...'));
            ...
            console.log(...oo_oo(`3921148959_120_6_120_65_4`, `Se encontraron ${resultado.length} registros`));
            return resultado;
        }
        catch (error) {
            console.error(...oo_tx(`3921148959_123_6_123_65_11`, 'Error detallado en getCajasPacking:', error));
    ...
    async getCajasValidadas() {
        try {
            ...
            console.error(...oo_tx(`3921148959_140_6_140_57_11`, 'Error en getCajasValidadas:', error));
    ...
    async getCajasPackingSummary(fecha, linea) {
        try {
            console.log(...oo_oo(`3921148959_148_6_150_7_4`, `Consultando resumen con filtros - fecha: ${fecha}, linea: ${linea}`));
            const where = {};
            if (fecha) {
            ...
            console.error(...oo_tx(`3921148959_185_6_185_72_11`, 'Error detallado en getCajasPackingSummary:', error));
    ...
    async getCajasValidadasSummary(fecha, linea) {
        try {
            console.log(...oo_oo(`3921148959_194_6_196_7_4`, `Consultando resumen con filtros - fecha: ${fecha}, linea: ${linea}`));
            const where = {};
            if (fecha) {
                where.Fecha_packing = fecha;
            }
            ...
            console.error(...oo_tx(`3921148959_231_6_231_72_11`, 'Error detallado en getCajasPackingSummary:', error));
            throw new common_1.InternalServerErrorException(`Error al obtener resumen de cajas packing: ${error.message}`);
        }
    }
    async getCajasDesviacionesSummary(fecha, linea) {
        try {
            console.log(...oo_oo(`3921148959_246_6_248_7_4`, `Consultando resumen de desviaciones con filtros - fecha: ${fecha}, linea: ${linea}`));
            const where = {};
            if (fecha) {
                where.Fecha_packing = fecha;
            }
            ...
            console.error(...oo_tx(`3921148959_280_6_280_77_11`, 'Error detallado en getCajasDesviacionesSummary:', error));
    ...
    async createRechazo(rechazoDto) {
        try {
            ...
            console.log(...oo_oo(`3921148959_297_6_297_58_4`, 'Valores recibidos para createRechazo:'));
            console.log(...oo_oo(`3921148959_298_6_298_57_4`, 'Folio:', Folio, 'tipo:', typeof Folio));
            console.log(...oo_oo(`3921148959_299_6_299_63_4`, 'Especie:', Especie, 'tipo:', typeof Especie));
            console.log(...oo_oo(`3921148959_300_6_300_57_4`, 'Cajas:', Cajas, 'tipo:', typeof Cajas));
            console.log(...oo_oo(`3921148959_301_6_301_60_4`, 'Camara:', Camara, 'tipo:', typeof Camara));
            console.log(...oo_oo(`3921148959_302_6_302_63_4`, 'Packing:', Packing, 'tipo:', typeof Packing));
            console.log(...oo_oo(`3921148959_303_6_303_75_4`, 'Motivos:', Motivos, 'es array:', Array.isArray(Motivos)));
            const existe = await this.verificarExistenciaFolio(Folio);
            if (!existe) {
                throw new common_1.NotFoundException(`El folio ${Folio} no existe en el sistema de existencias`);
            }
            ...
            for (const motivo of Motivos) {
                if (!motivo || !motivo.id) {
                    console.warn(...oo_tr(`3921148959_350_10_350_60_8`, 'Motivo sin ID, se omitirá:', motivo));
                    continue;
                }
                ...
                try {
                    ...
                    console.error(...oo_tx(`3921148959_383_10_383_89_11`, 'Error al crear registro de rechazo para motivo:', motivo, error));
                }
            }
            ...
            console.error(...oo_tx(`3921148959_398_6_398_53_11`, 'Error en createRechazo:', error));
            if (error instanceof common_1.ConflictException) {
                throw error;
            }
    ...
    async getMotivosRechazo() {
        try {
            ...
            console.error(...oo_tx(`3921148959_426_6_426_66_11`, 'Error al obtener motivos de rechazo:', error));
    ...
    async verificarRechazoPorFolio(folio) {
        try {
            ...
            console.error(...oo_tx(`3921148959_462_6_462_64_11`, 'Error en verificarRechazoPorFolio:', error));
    ...
    async actualizarEstadoRechazo(folio) {
        try {
            ...
            console.error(...oo_tx(`3921148959_500_6_500_63_11`, 'Error en actualizarEstadoRechazo:', error));
    ...
    async verificarValidacionPorFolio(folio) {
        try {
            ...
            console.error(...oo_tx(`3921148959_524_6_524_67_11`, 'Error en verificarValidacionPorFolio:', error));
    ...
    async getInformeDiario(fecha, estado) {
        try {
            ...
            console.error(...oo_tx(`3921148959_564_6_564_62_11`, 'Error al obtener informe diario:', error));
...
;
oo_te;
//# sourceMappingURL=validacion.service.js.map