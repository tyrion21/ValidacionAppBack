SELECT
  ...
  ISNULL(qcd.OBS_TOT_EXP, '0') AS [%QC]
FROM
  ...
  LEFT JOIN Erpfrusys.dbo.CTRL_TIT_DATOS AS qcd ON qcd.COD_EMP = R.COD_EMP
  AND qcd.COD_TEM = R.COD_TEM
  AND qcd.PLANILLA_REC = R.PLANILLA;