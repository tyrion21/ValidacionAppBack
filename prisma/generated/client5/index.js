...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\backend-validacion\\prisma\\generated\\client5",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\backend-validacion\\prisma\\schema5.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": "DATABASE_URL4",
        "value": null
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"./generated/client5\"\n}\n\ndatasource db {\n  provider = \"sqlserver\"\n  url      = env(\"DATABASE_URL4\")\n}\n\nmodel User {\n  id    Int     @id @default(autoincrement())\n  email String  @unique\n  name  String?\n}\n",
  "inlineSchemaHash": "45a34972ba340d7eecd2514b19f896d4cea4bdfb1f525b81593049387a4ce339",
  "copyEngine": true
}
...
path.join(process.cwd(), "prisma/generated/client5/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/generated/client5/schema.prisma")
